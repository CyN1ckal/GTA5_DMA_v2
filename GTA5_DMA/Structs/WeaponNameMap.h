...
std::unordered_map<uint32_t, std::string> WeaponNameMap = {
    // Melee
	...
	{0x6589186A,"Candy Cane"},
	{0xDAC00025,"The shocker"},
    ...
    { 0x93E220BD,  "Grenade" },
    { 0xA0973D5E,  "BZ Gas" },
    { 0x2C3731D9,  "Molotov Cocktail" },
    { 0x787F0BB,  "Sticky Bomb" },
